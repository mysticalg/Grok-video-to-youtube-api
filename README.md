...
- `OPENAI_ID_TOKEN_EXCHANGE_ENDPOINT` (optional override for id_token -> API token exchange endpoint; if unset, app falls back to `${OPENAI_API_BASE}/auth/id_token/exchange`)
